...
namespace Web.Areas.Identity.Pages.Account.Manage
{
    public partial class EmailModel : PageModel
    {
        ...
        public class InputModelValidator : AbstractValidator<InputModel>
        {
            ...
            private bool UniqueEmail(InputModel model, string newEmail)
            {
                return !_personRepository.ExistsByEmail(newEmail);
            }
        }
        ...
        public async virtual Task<IActionResult> OnPostChangeEmailAsync()
        {
            var user = await _userManager.GetUserAsync(User);
            if (user == null)
            {
        ...
        public async virtual Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            var user = await _userManager.GetUserAsync(User);
            if (user == null)
            {
